      ...
      <ResponsiveContainer>
        <ComposedChart data={viewMode === "overall" ? events : transformedData}>
          ...
          <Legend
            ...
            height={36}
            iconType="circle"
            wrapperStyle={{ fontSize: "0.85rem", color: "#8b9ab3" }}
          />
          ...
          {viewMode === "overall" && (
            <ReferenceLine
              y={70}
              stroke="rgba(200, 157, 124,0.45)"
              strokeDasharray="8 6"
              label={{
                value: "Fair threshold",
                position: "right",
                fill: "#C89D7C",
                fontSize: 11,
              }}
