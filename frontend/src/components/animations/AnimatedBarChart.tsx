    ...
    >
      ...
      {data.map((item, index) => {
        const percentage = Math.max(
          5,
          Math.min(100, (item.value / maxDomain) * 100),
        ); // Min 5% height to always be visible
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: isHovered
                  ? color === "#A24A46"
                    ? "0 0 16px rgba(162, 74, 70,0.55)"
                    : "0 0 16px rgba(200, 157, 124,0.55)"
                  : "none",
                position: "relative",
                overflow: "hidden",
              }}
