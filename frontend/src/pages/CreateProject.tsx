...
export default function CreateProject() {
  ...
  const handleCreateProject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newId = String(res.data.project_id);

      // Set projectId FIRST, then refresh so the new project is active
      setGlobalProjectId(newId);
  ...
  const handleRunAnalysis = async () => {
    ...
    try {
      ...
      setError(
        (err as { response?: { data?: { detail?: string } } }).response?.data
          ?.detail || "Analysis failed to start",
      );
      setLoading(false);
    }
  };
        ...
        {step === 1 && (
          <div
            ...
            style={{
              ...
              margin: "20px auto 0",
              textAlign: "left",
              background: "rgba(200, 157, 124,0.03)",
              border: "1px solid var(--border)",
            }}
          >
            <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
              <div className="workflow-brand-badge" style={{ flexShrink: 0 }}>
                <Info size={18} />
              </div>
              <div
                style={{
              ...
              >
                Configure your project identity, upload assets, and launch the
                forensic engine.
              </div>
            </div>
          </div>
          ...
          {[1, 2, 3].map((s) => (
            <div
              ...
              style={{
                ...
                boxShadow:
                  step === s ? "0 0 15px rgba(200, 157, 124, 0.3)" : "none",
              }}
            >
        ...
        {step === 1 && (
          ...
          >
            <div style={{ marginBottom: 32 }}>
              ...
              <p className="helper">
                Scope and domain definition for fairness intelligence.
              </p>
            </div>
            ...
            <form onSubmit={handleCreateProject} className="stack stack-lg">
              <div className="grid-2">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setProjectData({ ...projectData, domain: e.target.value })
                    }
                  >
              ...
              <button
                ...
                style={{ marginTop: 12, height: 50, fontSize: "0.95rem" }}
                disabled={loading}
              >
                {loading ? (
        ...
        {step === 2 && (
          ...
          >
            <div style={{ marginBottom: 32 }}>
              ...
              <p className="helper">
                Securely upload your evaluation datasets and model binary.
              </p>
            </div>
        ...
        {step === 3 && (
          ...
          >
            <div style={{ padding: "40px 0" }}>
              ...
              <p className="helper">
                The engine will run 8 stages of fairness audits including bias
                detection, explainability, and stress testing.
              </p>
