  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', paddingTop: 40 }}>
      <div className="page-header" style={{ textAlign: 'center', marginBottom: 40 }}>
        ...
        {step === 1 && (
          <div className="card-inset" style={{ maxWidth: 520, margin: '20px auto 0', textAlign: 'left', background: 'rgba(200, 157, 124,0.03)', border: '1px solid var(--border)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 32, gap: 12 }}>
          {[1, 2, 3].map(s => (
            <div key={s} style={{ 
              ...
              boxShadow: step === s ? '0 0 15px rgba(200, 157, 124, 0.3)' : 'none'
            }}>
