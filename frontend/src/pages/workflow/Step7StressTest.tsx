    ...
    return (
      <div className="card" style={{ padding: 40, textAlign: "center" }}>
        ...
        <p className="helper" style={{ marginTop: "16px" }}>
          Running custom stress scenarios...
        </p>
      </div>
    );
  }
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="helper" style={{ marginTop: 8 }}>
            Discover how the model's fairness holds up against data
            perturbations, missing values, and distribution shifts.
          </p>
        </div>
      </div>
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        >
          <div>
            ...
            <div className="helper" style={{ marginBottom: 16 }}>
              Create custom perturbations to test specific vulnerabilities.
            </div>
          </div>
          <button
            className="btn btn-primary"
            onClick={async () => {
              ...
              try {
                await runModelBias(
                  customScenarios.length > 0 ? customScenarios : undefined,
                );
              } catch (e) {
        ...
        <div className="grid-3">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setNewScenario({ ...newScenario, type: e.target.value })
              }
            >
          ...
          <div>
            ...
            <select
              className="select"
              value={`${newScenario.sensitive_col}:${newScenario.target_group}`}
              onChange={(e) => {
          ...
          <div>
            <label className="helper">
              Magnitude ({newScenario.magnitude})
            </label>
            <input
              type="range"
              min="0.1"
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            <input
              className="input"
              placeholder="e.g. Severe Stress on Minority"
          ...
          <button
            ...
            onClick={() => {
              ...
              setCustomScenarios([
                ...
                {
                  ...newScenario,
                  type: newScenario.type as CustomScenario["type"],
                },
              ]);
              ...
              {customScenarios.map((s, i) => (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      setCustomScenarios(
                        customScenarios.filter((_, idx) => idx !== i),
                      )
                    }
                  >
                    ×
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        <div className="section-title">
          ...
          <HelpButton
            module="stress_test"
            metricName="overall_fragility"
            metricValue={overall_fragility === "Low" ? 0.2 : overall_fragility === "Medium" ? 0.5 : 0.8}
          />
        </div>
        <div className="stat-number">{overall_fragility}</div>
        <div className="helper">
          Higher values indicate the model's fairness is highly sensitive to
      ...
      <div className="grid-2" style={{ marginBottom: 24, gap: "24px" }}>
        {scenarios?.map((scenario) => {
          const delta =
            scenario.fairness_score - scenario.baseline_fairness_score;
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span
                  className={`pill ${scenario.fragile ? "red" : "green"}`}
              ...
              >
                ...
                >
                  <div className="helper" style={{ marginBottom: "4px" }}>
                    Baseline
                  </div>
                  <div
                    style={{
                ...
                >
                  ...
                  <div
                    style={{
                      fontSize: "1.5rem",
                      fontWeight: 600,
                      color: isNegative ? "var(--warning)" : "var(--accent)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      gap: "4px",
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                >
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{
                      width: `${Math.max(0, Math.min(100, scenario.baseline_fairness_score))}%`,
                    }}
                    ...
                    style={{
                      ...
                      bottom: 0,
                      left: 0,
                      backgroundColor: "rgba(241,241,241,0.28)",
                      opacity: 0.5,
                    }}
                  />
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{
                      width: `${Math.max(0, Math.min(100, scenario.fairness_score))}%`,
                    }}
              ...
              >
                Accuracy Drop: {scenario.baseline_accuracy.toFixed(2)} →{" "}
                {scenario.accuracy.toFixed(2)}
              </div>
            </div>
          );
        })}
