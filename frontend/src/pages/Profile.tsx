...
export default function Profile() {
  ...
  const { projects, refreshProjects, setProjectId, deleteProject } =
    useAppContext();
    ...
    <div style={{ maxWidth: 1080, margin: "0 auto", paddingBottom: 80 }}>
      ...
      >
        <div>
          ...
          <p className="page-subtitle">
            Manage your identity, see your projects, and sign out across
            sessions.
          </p>
        </div>
      </motion.div>
      ...
      <div className="profile-grid">
        ...
        >
          ...
          >
            <div aria-hidden className="profile-avatar">
              {initials}
            </div>
                ...
                <div key={p.id} className="profile-project-row">
                  <div style={{ minWidth: 0 }}>
                    ...
                    <div className="profile-project-meta">
                      {p.domain || "general"} ·{" "}
                      {p.sensitive_columns?.length ?? 0} sensitive attribute
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    <button
                      ...
                      style={{
                        color: "var(--warning)",
                        borderColor: deletingId === String(p.id)
                          ? "rgba(162, 74, 70, 0.12)"
                          : "rgba(162, 74, 70, 0.32)",
                        opacity: deletingId === String(p.id) ? 0.5 : 1,
                      }}
                      onClick={async () => {
