...
export default function MonitoringDashboard() {
    ...
    return (
      <div style={{ maxWidth: 800, margin: "0 auto", paddingTop: 80 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          >
            Real-time tracking of model bias, feature distribution, and drift
            intelligence.
          </p>
        </div>
        <EmptyState
    ...
    return (
      ...
      >
        <Activity
          ...
          style={{ color: "var(--accent)", margin: "0 auto 24px" }}
        />
        <h2 className="section-title">Synchronizing Monitoring Stream...</h2>
        <p className="helper">
          Fetching latest fairness metrics and drift diagnostics.
        </p>
      </div>
    );
  }
  ...
  const currentScore =
    monitorData?.trend?.[monitorData.trend.length - 1]?.score || 0;
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <div
            style={{
              padding: "10px 24px",
              borderRadius: 100,
              border: `1px solid ${currentScore > 75 ? "var(--green)" : "var(--red)"}`,
              background:
                currentScore > 75
                  ? "rgba(34, 197, 94, 0.1)"
                  : "rgba(239, 68, 68, 0.1)",
              color: currentScore > 75 ? "var(--green)" : "var(--red)",
              fontWeight: 800,
              letterSpacing: 1,
            }}
          >
      ...
      >
        ...
        <div className="card" style={{ textAlign: "center" }}>
          ...
          <div
            style={{
              ...
              marginTop: 8,
              color:
                (trendData?.stability_score || 0) > 85
                  ? "var(--accent)"
                  : "var(--yellow)",
            }}
          >
            {trendData?.stability_score
              ? `${Math.round(trendData.stability_score)}%`
              : "--"}
          </div>
        </div>
        <div className="card" style={{ textAlign: "center" }}>
          ...
          <div
            style={{
              ...
              fontWeight: 800,
              marginTop: 8,
              color: alerts.length > 0 ? "#ef4444" : "var(--green)",
            }}
          >
            {alerts.length}
          </div>
        ...
        <div className="card" style={{ textAlign: "center" }}>
          ...
          <div style={{ marginTop: 12 }}>
            <span
              className={`pill ${currentScore > 65 ? "green" : "red"}`}
              style={{ fontSize: "0.9rem", padding: "6px 20px" }}
            >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <div className="card">
            ...
            >
              ...
              >
                ...
                <span
                  className={`pill ${driftDetected ? "red" : "green"}`}
              ...
              >
                <ShieldAlert
                  size={24}
                  style={{
                    color: trend === "DOWN" ? "#ef4444" : "var(--green)",
                    marginBottom: 12,
                    margin: "0 auto",
                  }}
                />
                ...
                <span
                  className={`pill ${trend === "DOWN" ? "red" : "green"}`}
                  style={{ fontSize: "0.7rem" }}
                >
          ...
          <div className="card">
            ...
            <p className="helper" style={{ marginBottom: 20 }}>
              Top feature shifts contributing to distribution drift.
            </p>
                ...
                alerts.slice(0, 5).map((a) => (
                  ...
                  >
                    ...
                    <span
                      style={{
                        color:
                          a.severity === "HIGH" ? "#ef4444" : "var(--yellow)",
                        fontWeight: 800,
                        textAlign: "right",
                        maxWidth: "60%",
                      }}
            ...
            {alerts.length > 0 ? (
              alerts.map((a) => (
                <div
                  ...
                  className="card-inset"
                  style={{
                    borderLeft: `4px solid ${a.severity === "HIGH" ? "#ef4444" : "var(--yellow)"}`,
                  }}
                >
                  <div
                    style={{
