...
def run_model_bias_analysis(df: pd.DataFrame, sensitive_cols: list[str], target_col: str, model_path: str | None = None) -> dict[str, Any]:
    ...
    fairness_score = fairness_score_from_gaps(metrics)
