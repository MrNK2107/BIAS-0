        ...
        recommendations.append(
            {
                ...
                "mitigation_options": [
                    {
                        "option": "default",
                        "rationale": "Dropping the proxy feature eliminates indirect discrimination pathways.",
                    }
                ],
        ...
        recommendations.append(
            {
                ...
                "mitigation_options": [
                    {
                        "option": "default",
                        "rationale": "Adversarial training forces the model to learn invariant representations.",
                    }
                ],
        ...
        recommendations.append(
            {
                ...
                "mitigation_options": [
                    {
                        "option": "default",
                        "rationale": "Robust training improves model stability across demographic strata.",
                    }
                ],
        ...
        recommendations.append(
            {
                ...
                "mitigation_options": [
                    {
                        "option": "default",
                        "rationale": "Synthetic oversampling ensures minority groups are adequately represented.",
                    }
                ],
        ...
        recommendations.append(
            {
                ...
                "mitigation_options": [
                    {
                        "option": "default",
                        "rationale": "Fairness constraints explicitly penalize disparate outcomes during training.",
                    }
                ],
        ...
        recommendations.append(
            {
                ...
                "mitigation_options": [
                    {
                        "option": "default",
                        "rationale": "Post-processing threshold adjustment provides quick, reversible improvements.",
                    }
                ],
                "type": "monitoring",
            }
